...
//     });
//     return { error: (result as { error?: Error }).error ?? null };
//   };
...
//   return (
//     <AuthContext.Provider value={{ session, user, isLoading, isAdmin, signUp, signIn, signInWithGoogle, signOut, resetPassword }}>
//       {children}
...
interface AuthContextType {
  ...
  signUp: (email: string, password: string) => Promise<{ error: Error | null; data: any }>;
  signIn: (email: string, password: string) => Promise<{ error: Error | null }>;
  signUpWithPhone: (phone: string, password: string) => Promise<{ error: Error | null; data: any }>;
...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  // Mobile number + password signup/login — no OTP. Supabase Auth still owns
  // password hashing; we never touch or store the raw password ourselves.
  ...
  return (
    <AuthContext.Provider value={{ session, user, isLoading, isAdmin, signUp, signIn, signUpWithPhone, signInWithPhone, signInWithGoogle, signOut, resetPassword }}>
      {children}
    </AuthContext.Provider>
  );
};
