...
const RefundPolicy: React.FC = () => {
  return (
    <div className="min-h-screen flex flex-col">
      <SEO title="Refund Policy" description="Ankshaastra refund & return policy. 7-day return window with videographic proof for damage claims. Read our complete refund terms." canonical="/refund-policy" />
      <Header />
