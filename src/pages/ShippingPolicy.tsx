...
const ShippingPolicy: React.FC = () => {
  return (
    <div className="min-h-screen flex flex-col">
      <SEO title="Shipping Policy" description="Free shipping on all orders at Ankshaastra. 4-day dispatch, 7-15 days domestic delivery, 20-30 days international. Read our shipping details." canonical="/shipping-policy" />
      <Header />
