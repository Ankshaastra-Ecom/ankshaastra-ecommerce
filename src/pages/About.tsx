...
const About: React.FC = () => {
  return (
    <div className="min-h-screen flex flex-col">
      <SEO
        title="About Us — Our Spiritual Journey"
        description="Ankshaastra brings 10+ years of expertise in authentic Rudraksha, crystals & spiritual products. Learn about our mission to empower spiritual seekers worldwide."
        canonical="/about"
      />
      <Header />
